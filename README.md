...
Bu课表是一款面向大学生日常使用的 Android 课程表应用。应用重点放在轻量、清晰、可维护：课程数据保存在本地，支持手动维护、学校教务导入、AI 截图识别后的 CSV/文本导入、学期管理和桌面小组件。
...
- 学期管理：支持创建、切换、删除学期，并按学期导入或导出课程数据。
- ICS 日历导入：支持从 `.ics` 日历文件导入课程。
- 周视图显示密度：可在设置中选择紧凑、标准、舒展三种课程卡片排版。
- 桌面小组件：提供大小两种课程表小组件，展示今日/明日课程，点击组件可回到应用。
- 后台提醒与系统入口：支持上课提醒，并探索适配系统级实时状态展示。
...
<p>
  ...
  <img src="docs/images/widget-screenshot.jpg" alt="Bu课表桌面小组件" width="320">
</p>
...
- 新增学期管理、学期导入/导出和 ICS 日历导入。
- 新增大小桌面小组件，并修复点击小组件不跳转应用的问题。
- 新增周视图课程卡片密度设置，不同字号会配套调整间距和信息展示。
